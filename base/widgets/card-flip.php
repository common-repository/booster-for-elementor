...
class ELB_CardFlip_Widget extends Widget_Base {
    public function get_name() {
        return 'elb-cardflip-widget';
    }
    public function get_title() {
        return esc_html__('Card Flip', 'booster-addons');
    }
    ...
    protected function render() {
        ...
        $output .= '<div class="elb-cflp-ctn elb-flip-ctn" '.$ctn_attr.'>
        ...
        echo apply_filters('elb_cardflip_output', $output, $settings);
    }
