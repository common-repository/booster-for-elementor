...
class ELB_SocialFindUs_Widget extends Widget_Base {
    public function get_name() {
        return 'elb-socialfindus-widget';
    }
    public function get_title() {
        return esc_html__('Social Find Us', 'booster-addons');
    }
    public function get_icon() {
        return 'elb-icon eicon-social-icons';
    }
    ...
    protected function _register_controls() {
        ...
        ********************************************/
        ...
        $repeater->add_control(
            'social_id',
            [
                'label' => esc_html__('Social Site', 'booster-addons'),
                'type' => Controls_Manager::SELECT,
                'label_block' => true,
                'options' => elb_social_findus_array(),
            ]
        );
        $repeater->add_control(
            'social_link', [
                'label' => esc_html__('Social Link', 'booster-addons'),
                'default' => '#',
        ...
        $this->add_control(
            'open_in',
            [
                'label' => esc_html__('Open Link In', 'booster-addons'),
                'type' => Controls_Manager::SELECT,
                'label_block' => true,
                'options' => [
                    '_blank'    =>  esc_html__('New Tab','booster-addons'), 
                    '_self'  =>  esc_html__('Same Window','booster-addons'), 
                ],
                'default' => '_blank',
            ]
        );
        ...
        if($settings['social_list']):
            ...
            $output = '<div class="elb-social-ctn" data-icon-align="'.esc_attr($settings['icon_align']).'">';
                foreach($settings['social_list'] as $social):
                    $output .= elb_render_social_content('find_us',$social_array,$social['social_id'],$social['social_link'],$social_styling);
                endforeach;
            $output .= '</div>';

        endif;

        echo apply_filters('elb_socialfindus_output', $output, $settings);
